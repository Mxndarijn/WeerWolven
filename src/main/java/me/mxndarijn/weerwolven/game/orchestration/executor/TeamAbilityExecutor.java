// me.mxndarijn.weerwolven.game.orchestration.executor.TeamAbilityExecutor
...
public interface TeamAbilityExecutor {
    ...
    List<ActionIntent> defaultExecute(Game game, List<GamePlayer> actors, long timeoutMs);
}
